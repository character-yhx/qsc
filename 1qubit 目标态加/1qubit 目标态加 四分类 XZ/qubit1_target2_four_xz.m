...
hold on
MLP_train_one_episode = xlsread('1qubit_target2_four_xz_MLP_episode10000_10runs_训练acc.xls', 'B:B');
...
hold on
QNN_train_one_episode = xlsread('1qubit_target2_four_xz_QNN_episode10000_10runs_训练acc.xls', 'B:B');
...
hold on
QNN_MLP_train_one_episode = xlsread('1qubit_target2_four_xz_QNN_MLP_episode10000_10runs_训练acc.xls', 'E:E');
...
hold on
MLP_test_one_episode = xlsread('1qubit_target2_four_xz_MLP_episode10000_10runs_测试acc.xls', 'B:B');
x=1:length(MLP_test_one_episode(:));
A = plot(x, MLP_test_one_episode,'-', 'LineWidth',1.5,'Marker','s',...
    'MarkerSize',4,'MarkerFaceColor',[0.171875,0.63671875,0.37890625],'MarkerIndices',[2000 4000 6000 8000 10000], 'color',[0.171875,0.63671875,0.37890625]);
hold on
QNN_test_one_episode = xlsread('1qubit_target2_four_xz_QNN_episode10000_10runs_测试acc.xls', 'B:B');
x=1:length(QNN_test_one_episode(:));
B = plot(x, QNN_test_one_episode,'-', 'LineWidth',1.5,'Marker','o',...
    'MarkerSize',4,'MarkerFaceColor',[0.9453125,0.41796875,0.30078125],'MarkerIndices',[2000 4000 6000 8000 10000], 'color',[0.9453125,0.41796875,0.30078125]);
hold on
QNN_MLP_test_one_episode = xlsread('1qubit_target2_four_xz_QNN_MLP_episode10000_10runs_测试acc.xls', 'E:E');
